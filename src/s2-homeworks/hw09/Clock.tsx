...
function Clock() {
    const [timerId, setTimerId] = useState<number | any>(undefined)
    ...
    const start = () => {
        ...
        const tId = setInterval(() => setDate(new Date(Date.now())), 1000)
        setTimerId(tId)
    }
    ...
    const stringDate = date.toLocaleDateString().split('/').join('.') || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
    ...
    return (
        <div className={s.clock}>
            ...
            >
                ...
                <span className={s.watch} id={'hw9-time'}>
